...
$pageTitle = "S&P 500 Companies - NextGen Finance Feed";
...
$sql = "SELECT name, ticker, is_active FROM companies WHERE index_name = 'S&P 500' ORDER BY is_active DESC, name";
...
<section class="page-wrapper">
    <div class="page-header">
        ...
        <p class="page-subtitle">Explore the companies listed under S&amp;P 500 Index</p>
    </div>
